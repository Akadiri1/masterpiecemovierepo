...
<div class="sign-in-page vh-100"
    style="background-image: url(https://templates.iqonic.design/streamit-dist/frontend/html//assets/images/pages/01.webp); background-size: cover; background-repeat: no-repeat;">
    <div class="container">
        <div class="row justify-content-center align-items-center height-self-center vh-100">
            <div class="col-lg-5 col-md-12 align-self-center">
                <div class="user-login-card rounded-3">
                    ...
                    <div class="mb-3">
                      <label for="login-identity" class="mb-2 custom-form-label">
                        Username or Email Address *</label>
                      <input placeholder="Enter username or email" autocomplete="off" required type="text"
                        id="login-identity" name="identity" class="mb-0 form-control" />
                      <div class="invalid-feedback">Please enter your username or email.</div>
                    </div>

                    <div class="mb-3">
                      <label for="login-password" class="mb-2 custom-form-label">
                        Password *</label>
                      <div class="input-group custom-input-group mb-3">
                        <input placeholder="Password" required type="password"
                          id="login-password" name="password" class="mb-0 form-control">
                    ...
                    <button type="submit" id="login-button"
                      class="btn btn-primary text-capitalize position-relative w-100 my-3 rounded-3">
                    ...
                    <div class="social-login-section text-center mt-3">
                      <ul class="list-inline m-0 p-0">
                        <li class="list-inline-item">
                          <a href="/auth/google" class="btn btn-light" style="width: 150px;">
                            <i class="fab fa-google me-2"></i> Google
                          </a>
                        </li>
                        <li class="list-inline-item">
                          <a href="/auth/facebook" class="btn btn-light" style="width: 150px;">
  ...
  <div id="back-to-top" class="back-to-top" style="display: none;">
     <a class="p-0 btn bg-primary btn-sm position-fixed top border-0 rounded-circle text-white" id="top" href="login.html#top">
...
<script>
  ...
  const formMessage = document.querySelector("#form-message"); // For "Invalid" errors
  ...
  function clearErrors() {
    loginForm.querySelectorAll(".is-invalid").forEach(input => {
      input.classList.remove("is-invalid");
    });
    formMessage.innerHTML = "";
    formMessage.className = "mb-3"; // Reset classes
  }
  
  function showFormMessage(message, type) {
    // Shows "Invalid username/password"
  ...
  loginForm.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      if (response.ok) {
        // --- SUCCESS ---
        // Server said login was good. Redirect.
        // The PHP script will send us where to go.
